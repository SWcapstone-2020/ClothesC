...
public class ItemViewerAdapter extends RecyclerView.Adapter<ItemViewerAdapter.ItemViewHolder> {
    ...
    public ItemViewerAdapter(Activity activity, ArrayList<ClothesItem> myDataset) {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final ItemViewerAdapter.ItemViewHolder ItemViewHolder = new ItemViewerAdapter.ItemViewHolder(cardView);
